...
export const mockPaymentEventSucceeded: Stripe.Event = {
  id: 'evt_3Ml9oNKApGjVGa9t1GYQjEZf',
  object: 'event',
  api_version: '2022-11-15',
  created: 1678707909,
  data: {
    object: {
      ...
      next_action: null,
      on_behalf_of: null,
      payment_method: 'pm_1Ml9oNKApGjVGa9tRjSciOQv',
      payment_method_options: {
        card: {
          installments: null,
          mandate_options: null,
...
export const mockedChargeSucceeded: Stripe.Charge = {
  id: 'ch_3Ml9oNKApGjVGa9t1OUdurC4',
  object: 'charge',
  amount: 2000,
  ...
  application_fee: null,
  application_fee_amount: null,
  balance_transaction: 'txn_3Ml9oNKApGjVGa9t1nmGszU5',
  billing_details: {
    address: {
      city: null,
      country: 'BG',
  ...
  livemode: false,
  metadata: {
    campaignId: '3149fe87-7eb9-4725-bc72-4edd01cfefde',
  },
  on_behalf_of: null,
  outcome: {
    network_status: 'approved_by_network',
  ...
  paid: true,
  payment_intent: 'pi_3Ml9oNKApGjVGa9t1pNTaLRf',
  payment_method: 'pm_1Ml9oNKApGjVGa9tRjSciOQv',
  payment_method_details: {
    card: {
      brand: 'visa',
  ...
  receipt_number: null,
  receipt_url:
    'https://pay.stripe.com/receipts/payment/CAcaFwoVYWNjdF8xSVJkc1VLQXBHalZHYTl0KLzsvKAGMgYbtH8HrFU6LBabH-PCKss5TNM3Ry1l5toasRWWumsAmR1sQZ3TiUTUi8d7lrK4LzFwLEgK',
  refunded: false,
  refunds: null,
  review: null,
  shipping: null,
